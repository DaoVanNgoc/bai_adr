...
class ProductsProvider with ChangeNotifier {
  static final List<ProductModel> _productsList = [
    ProductModel(
        ...
        id: "3",
        imageUrl: "https://images.baodantoc.vn/uploads/2022/Th%C3%A1ng%203/Ng%C3%A0y_11/Thanh/cong-dung-va-phuong-phap-lam-dep-da-tu-qua-chanh-ma-ai-cung-nen-biet-qau-chanh.jpg",
        isPiece: true,
    ...
    ProductModel(
        ...
        id: "2",
        imageUrl:
        "https://citifruit.com/uploads/images/Products/du-du-do-800x800.png",
        isPiece: true,
        isProductOnSale: true,
        price: 5,
        salePrice: 3,
    ...
    ,imageUrl:"https://i.ibb.co/GFvm1Zd/Onions.png",
        isPiece:true,
       isProductOnSale:true,price:     59,salePrice:28,title:"Onions"
    ),
    ProductModel(
  categoryName:"Fruits",
  ...
  id:"1"
  ,imageUrl:
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwjQeZEoxkacPFp1Aw8BxhYSxD3gDptXVZ-w&usqp=CAU",
  isPiece: false,
  ...
  ProductModel(
    ...
    ProductModel(
      ...
      price: 10,
      salePrice: 2,
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR61IwCDZgHVKs03y93SHUVi0EqDFiJ3kC8XA&usqp=CAU',
  ...
  List<ProductModel> get getProducts {
    fetchProducts();
    print("Product ${_productsList.length}");
  ...
  Future<void> fetchProducts() async {
    await FirebaseFirestore.instance
      ...
      // _productsList = [];
      // _productsList.clear();
      productSnapshot.docs.map((element) {
        _productsList.add(ProductModel(
          ...
          isProductOnSale: element.get('isProductOnSale'),
